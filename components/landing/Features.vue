...
<template>
  <div class="mt-16 md:mt-0">
    <h2 class="text-4xl lg:text-5xl font-bold lg:tracking-tight">
      Everything you need to start a VPN 
    </h2>
    <p class="text-lg mt-4 text-slate-600">
      ROAR VPN comes batteries included. It takes the best parts of state-of-the-art
