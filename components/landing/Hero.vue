  ...
  <main class="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-8">
    ...
    <div>
      ...
      <p class="text-lg mt-4 text-slate-600 max-w-xl">
        Roar VPN is a product for personal, public devices &
        Enterprise Level VPN.<wbr /> Built with Security & High Availability. You can quickly
        launch you VPN Business or Secure your devices anytime anywhere.
      </p>
